...
exports.prettyLog = exports.deepMerge = exports.getHash = exports.getDefaultHosts = exports.getLocalV4Ips = exports.exec = exports.writeFile = exports.readFile = exports.ensureDirExist = exports.mkdir = exports.resolvePath = exports.exists = void 0;
...
const mkdir = (dirname) => __awaiter(void 0, void 0, void 0, function* () {
    const isExist = yield exports.exists(dirname);
    if (!isExist) {
...
const writeFile = (filePath, data) => __awaiter(void 0, void 0, void 0, function* () {
    yield exports.ensureDirExist(filePath);
